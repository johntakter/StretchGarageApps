...
namespace StretchGarage.Shared
{
    ...
    {
        private static string _weburl = "http://stretchgarageweb.azurewebsites.net/api"; //"http://localhost:3186/api";
        ...
        {
            string url = string.Format("{0}/CheckLocation/?id={1}&latitude={2}&longitude={3}", _weburl, id, latitude, longitude);
            url = url.Replace(',', '.');
